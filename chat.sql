...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11-Abr-2024 às 14:21
...
CREATE TABLE `users` (
  ...
  `profile` varchar(12) NOT NULL DEFAULT 'user.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
ALTER TABLE `messages`
  MODIFY `pk_message_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;
